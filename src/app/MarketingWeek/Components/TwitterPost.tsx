...
export function TwitterPost({ text }: { text: string }) {
  const nowInTwitterFormat = format(new Date(), 'h:mm a · MMM d, yyyy')
  return (
    <div className="max-w-xl p-4 bg-white border border-gray-200 col-span-1 dark:bg-gray-800 dark:border-gray-800 rounded-xl">
